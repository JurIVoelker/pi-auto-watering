# pi-auto-watering
For my seminar paper in Media Computer Science, I am developing an automatic watering system using a Raspberry Pi. The system determines the optimal watering time based on the weight of the plant, which is measured with a load cell. In addition, a camera captures images to monitor growth and create time-lapse videos.
